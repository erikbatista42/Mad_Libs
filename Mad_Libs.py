...
def test():
    print("Hey, my name is %s . I am %s years old. For fun, I like to %s and %s. My favorite color is %s. I have %s siblings. For work, I %s. My favorite place to be is %s. The closest person to me is %s. I'm from %s and I live in %s. I like to listen to %s. One thing I want to learn is %s." % (firstName, age, first_thing_you_do_for_fun, second_thing_you_do_for_fun, favColor, num_of_siblings, what_you_do_for_work, fav_place_to_be, name_of_closest_person, where_you_from, where_do_you_live, what_type_of_music_you_listen_to, one_thing_you_want_to_learn) )   
